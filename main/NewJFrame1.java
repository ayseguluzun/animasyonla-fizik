...
public class NewJFrame1 extends javax.swing.JFrame {
    ...
    public NewJFrame1() {
        initComponents();
        this.setSize(734, 516);
        Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
        this.setLocation(dim.width / 2 - this.getSize().width / 2, dim.height / 2 - this.getSize().height / 2);

        AnimationClass anim = new AnimationClass();
        anim.jLabelXLeft(jLabel1.getX(), -1000, 3, 1, jLabel1);
        anim.jLabelXRight(jLabel2.getX(), 1000, 9, 1, jLabel2);
        anim.jLabelYDown(jLabel3.getY(), 1000, 9, 1, jLabel3);
        anim.jLabelYDown(jLabel4.getY(), 1000, 6, 1, jLabel4);
    }
